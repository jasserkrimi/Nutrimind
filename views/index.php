...
<body>
			...
			<div class="row">
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						...
						<p class="subtitle">Frais & Biologique</p>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 text-center">
					...
					<h3>Fraise</h3>
					<p class="product-price"><span>Par Kg</span> 85$ </p>
				...
				<div class="col-lg-4 col-md-6 text-center">
					...
					<h3>Baie</h3>
					<p class="product-price"><span>Par Kg</span> 70$ </p>
					<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Ajouter au Panier</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
					...
					<h3>Citron</h3>
					<p class="product-price"><span>Par Kg</span> 35$ </p>
					<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Ajouter au Panier</a>
					</div>
				</div>
			</div>
					...
					<div class="testimonial-sliders">
						<div class="single-testimonial-slider">
							...
							<div class="client-meta">
								<h3>Saira Hakim <span>Propriétaire de magasin local</span></h3>
						...
						<div class="single-testimonial-slider">
							...
							<div class="client-meta">
								<h3>David Niph <span>Propriétaire de magasin local</span></h3>
								<p class="testimonial-body">
									" Sed ut perspiciatis unde omnis iste natus error veritatis et  quasi architecto beatae vitae dict eaque ipsa quae ab illo inventore Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium "
								</p>
								<div class="last-icon">
						...
						<div class="single-testimonial-slider">
							...
							<div class="client-meta">
								<h3>Jacob Sikim <span>Propriétaire de magasin local</span></h3>
								<p class="testimonial-body">
									" Sed ut perspiciatis unde omnis iste natus error veritatis et  quasi architecto beatae vitae dict eaque ipsa quae ab illo inventore Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium "
								</p>
								<div class="last-icon">
	...
	<section class="shop-banner">
    	<div class="container">
        	<h3>La vente de décembre est ouverte! <br> avec une grande <span class="orange-text">Réduction...</span></h3>
	...
	<div class="latest-news pt-150 pb-150">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">	
						<h3><span class="orange-text">Nos</span> Actualités</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid, fuga quas itaque eveniet beatae optio.</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12 text-center">
					<a href="news.html" class="boxed-btn">Plus d'Actualités</a>
				</div>
			</div>
		</div>
	</div>
