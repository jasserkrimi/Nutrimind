...
<head>
    ...
    <title>Nutrimind - Mot de passe oublié</title>
                    ...
                    <div class="login-snip">
                        ...
                        <div class="login-space">
                            <form id="forgotPasswordForm">
                                ...
                                <div class="group">
                                    <input type="submit" class="button" value="Envoyer le code">
                                </div>
                                <div class="hr"></div>
                                <div class="foot">
        ...
        document.getElementById('forgotPasswordForm').addEventListener('submit', function(e) {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    // If we have a code, redirect immediately, otherwise wait 2 seconds
                    const redirectDelay = data.code ? 500 : 2000;
                    ...
                    submitBtn.value = 'Envoyer le code';
                }
            })
            .catch(error => {
