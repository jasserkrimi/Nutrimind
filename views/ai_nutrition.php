  ...
  <div class="container">
    ...
    <div class="row mb-5">
      <div class="col-12 text-center d-flex flex-wrap justify-content-center gap-2">
        ...
        <a href="ai_sommeil.php"   class="ai-tab" style="--c:#6366f1;--cs:#4f46e5;">
          <i class="fas fa-moon"></i> Plan Sommeil
        </a>
        <a href="ai_nutrition.php" class="ai-tab active" style="--c:#10b981;--cs:#059669;">
    ...
    <div class="row">
      <div class="col-lg-10 offset-lg-1">
        <div class="ai-card" style="--accent:#10b981;--accent-light:#d1fae5;">
          <div class="ai-card-header" style="background:linear-gradient(135deg,#10b981,#34d399);">
            <span class="ai-card-icon">🥗</span>
            <div>
              <h4 class="ai-card-title">Plan Nutrition</h4>
              <p class="ai-card-sub">Repas, macronutriments &amp; hydratation</p>
            </div>
          </div>
          <div class="ai-card-body">
            <?php echo renderAIPlan($plans['nutrition']); ?>
          </div>
        </div>
      </div>
    </div>
