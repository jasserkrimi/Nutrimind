          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="activer_notification" name="activer_notification" value="1" checked>
                    <label class="form-check-label" for="activer_notification">
                        <i class="ti ti-bell me-1"></i><strong>Activer notification</strong>
                        <br><small class="text-muted">Recevoir une notification 5 minutes avant la séance</small>
                    </label>
                </div>
            </div>
          </div>
