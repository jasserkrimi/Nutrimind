...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $result = $planningController->create($_POST);

    if ($result['success']) {
        $_SESSION['success_message'] = "Plan crÃ©Ã© avec succÃ¨s!";
...
<head>
  <meta charset="UTF-8" />
  <title>Create Planning - NutriMind Admin</title>
...
<body>
  ...
  <nav id="topbar" class="navbar bg-white border-bottom fixed-top topbar px-3">
    ...
    <div>
      <h4 class="mb-0">Create Planning</h4>
    </div>
  </nav>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="nav flex-column">
      ...
      <li><a class="nav-link active" href="planning_create.php"><i class="ti ti-plus"></i><span
      ...
      <div class="row">
        <div class="col-12">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
              <h1 class="fs-3 mb-1">CrÃ©er un Plan</h1>
              <p>CrÃ©er un nouveau plan nutritionnel pour un utilisateur</p>
            </div>
            <a href="planning_list.php" class="btn btn-secondary">
              <i class="ti ti-arrow-left me-2"></i>Retour Ã  la liste
            </a>
          </div>
        </div>
      </div>
          ...
          <div class="card">
            <div class="card-body">
              <form method="POST" class="form">
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control <?php echo isset($errors['objectif_id']) ? 'is-invalid' : ''; ?>"
                      ...
                      <option value="">SÃ©lectionner un objectif</option>
                      <?php foreach ($objectives as $objectif): ?>
                        <option value="<?php echo htmlspecialchars($objectif['id_objectif']); ?>"
                                ...
                                <?php echo (isset($_POST['objectif_id']) && $_POST['objectif_id'] == $objectif['id_objectif']) ? 'selected' : ''; ?>
                                style="display: <?php echo (isset($_POST['user_id']) && $_POST['user_id'] == $objectif['user_id']) ? 'block' : 'none'; ?>;">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control <?php echo isset($errors['titre']) ? 'is-invalid' : ''; ?>"
                        ...
                        value="<?php echo isset($_POST['titre']) ? htmlspecialchars($_POST['titre']) : ''; ?>" maxlength="100">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control" id="statut" name="statut">
                      ...
                      <option value="termine" <?php echo (isset($_POST['statut']) && $_POST['statut'] == 'termine') ? 'selected' : ''; ?>>TerminÃ©</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <label for="date_debut" class="form-label font-weight-bold">Date de dÃ©but</label>
                ...
                <div class="row">
                  <div class="col-md-4 mb-3">
                    ...
                    <input type="number" class="form-control <?php echo isset($errors['calories_par_jour']) ? 'is-invalid' : ''; ?>"
                        id="calories_par_jour" name="calories_par_jour" placeholder="2000" min="500" max="10000"
                        value="<?php echo isset($_POST['calories_par_jour']) ? htmlspecialchars($_POST['calories_par_jour']) : ''; ?>">
                    <small class="form-text text-muted">Entre 500 et 10000 kcal</small>
                  ...
                  <div class="col-md-4 mb-3">
                    <label for="nombre_repas_par_jour" class="form-label font-weight-bold">Nombre de repas</label>
                    <input type="number" class="form-control <?php echo isset($errors['nombre_repas_par_jour']) ? 'is-invalid' : ''; ?>"
                        id="nombre_repas_par_jour" name="nombre_repas_par_jour" placeholder="3" min="1" max="10"
                        value="<?php echo isset($_POST['nombre_repas_par_jour']) ? htmlspecialchars($_POST['nombre_repas_par_jour']) : ''; ?>">
                    <small class="form-text text-muted">Entre 1 et 10 repas</small>
                  ...
                  <div class="col-md-4 mb-3">
                    <label for="heures_sommeil_par_jour" class="form-label font-weight-bold">Heures de sommeil</label>
                    <input type="number" step="0.5" class="form-control <?php echo isset($errors['heures_sommeil_par_jour']) ? 'is-invalid' : ''; ?>"
                        id="heures_sommeil_par_jour" name="heures_sommeil_par_jour" placeholder="8" min="0" max="24"
                        value="<?php echo isset($_POST['heures_sommeil_par_jour']) ? htmlspecialchars($_POST['heures_sommeil_par_jour']) : ''; ?>">
                    <small class="form-text text-muted">Entre 0 et 24 heures</small>
                ...
                <div class="row">
                  <div class="col-md-4 mb-3">
                    <label for="objectif_proteines" class="form-label font-weight-bold">ProtÃ©ines (g)</label>
                    <input type="number" class="form-control <?php echo isset($errors['objectif_proteines']) ? 'is-invalid' : ''; ?>"
                        id="objectif_proteines" name="objectif_proteines" placeholder="150" min="0" max="2000"
                        value="<?php echo isset($_POST['objectif_proteines']) ? htmlspecialchars($_POST['objectif_proteines']) : ''; ?>">
                    <small class="form-text text-muted">Entre 0 et 2000g</small>
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <input type="number" class="form-control <?php echo isset($errors['objectif_glucides']) ? 'is-invalid' : ''; ?>"
                        id="objectif_glucides" name="objectif_glucides" placeholder="200" min="0" max="2000"
                        value="<?php echo isset($_POST['objectif_glucides']) ? htmlspecialchars($_POST['objectif_glucides']) : ''; ?>">
                    <small class="form-text text-muted">Entre 0 et 2000g</small>
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <input type="number" class="form-control <?php echo isset($errors['objectif_lipides']) ? 'is-invalid' : ''; ?>"
                        id="objectif_lipides" name="objectif_lipides" placeholder="70" min="0" max="2000"
                        value="<?php echo isset($_POST['objectif_lipides']) ? htmlspecialchars($_POST['objectif_lipides']) : ''; ?>">
                    <small class="form-text text-muted">Entre 0 et 2000g</small>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <label for="heures_entrainement_par_jour" class="form-label font-weight-bold">Heures d'entraÃ®nement</label>
                    <input type="number" step="0.5" class="form-control <?php echo isset($errors['heures_entrainement_par_jour']) ? 'is-invalid' : ''; ?>"
                        id="heures_entrainement_par_jour" name="heures_entrainement_par_jour" placeholder="1.5" min="0" max="24"
                        value="<?php echo isset($_POST['heures_entrainement_par_jour']) ? htmlspecialchars($_POST['heures_entrainement_par_jour']) : ''; ?>">
                    <small class="form-text text-muted">Entre 0 et 24 heures</small>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <textarea class="form-control <?php echo isset($errors['description']) ? 'is-invalid' : ''; ?>"
                        ...
                        placeholder="Description dÃ©taillÃ©e du plan..."><?php echo isset($_POST['description']) ? htmlspecialchars($_POST['description']) : ''; ?></textarea>
                    <small class="form-text text-muted">Maximum 1000 caractÃ¨res</small>
                ...
                <div class="row">
                  <div class="col-12 text-center">
                    <button type="submit" class="btn btn-primary">
                      <i class="ti ti-device-floppy me-2"></i>CrÃ©er le plan
                    </button>
                    <a href="planning_list.php" class="btn btn-secondary ms-2">
  ...
  <script>
    ...
    // Load objectives on page load if user is pre-selected
