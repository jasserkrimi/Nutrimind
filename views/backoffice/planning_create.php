      ...
      <div class="row">
        <div class="col-12">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
              <h1 class="fs-3 mb-1">Créer un Plan</h1>
              <p>Créer un nouveau plan nutritionnel pour un utilisateur</p>
            </div>
          ...
          <div class="card">
            <div class="card-body">
              <form method="POST" class="form">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <label for="heures_entrainement_par_jour" class="form-label font-weight-bold">Heures d'entraînement</label>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <textarea class="form-control <?php echo isset($errors['description']) ? 'is-invalid' : ''; ?>"
                        ...
                        placeholder="Description détaillée du plan..."><?php echo isset($_POST['description']) ? htmlspecialchars($_POST['description']) : ''; ?></textarea>
                ...
                <div class="row">
                  <div class="col-12 text-center">
                    <button type="submit" class="btn btn-primary">
                      <i class="ti ti-device-floppy me-2"></i>Créer le plan
                    </button>
