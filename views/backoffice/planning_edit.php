...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result['success']) {
        $_SESSION['success_message'] = "Plan modifi̩ avec succ̬s!";
        header('Location: planning_list.php');
        exit;
    } else {
        ...
        <div class="col-12">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
              ...
              <p>Modifier les d̩tails du plan nutritionnel</p>
            </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <p class="card-description">Modifiez les d̩tails du plan nutritionnel pour l'utilisateur.</p>
            </div>
            <div class="card-body">
                <form method="POST" action="">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <select class="form-control" id="statut" name="statut">
                        ...
                        <option value="termine" <?php echo ($planning['statut'] == 'termine') ? 'selected' : ''; ?>>Termin̩</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control <?php echo isset($errors['description']) ? 'is-invalid' : ''; ?>"
                        ...
                        placeholder="Description d̩taill̩e du plan nutritionnel"><?php echo htmlspecialchars($planning['description'] ?? ''); ?></textarea>
                  ...
                  <div class="mb-3">
                    <label for="heures_entrainement_par_jour" class="form-label font-weight-bold">Heures d'entrąnement par jour</label>
