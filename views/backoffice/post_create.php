...
$errors = [];
$values = ['titre'=>'','contenu'=>'','categorie'=>'','image_url'=>'','statut'=>'publie','user_id'=>''];
...
<head>
  <meta charset="UTF-8">
  <title>Créer un Post - NutriMind Admin</title>
...
<nav id="topbar" class="navbar bg-white border-bottom fixed-top topbar px-3">
  ...
  <div><h4 class="mb-0">Créer un Post</h4></div>
</nav>
<aside id="sidebar" class="sidebar">
  ...
  <ul class="nav flex-column">
    ...
    <li><a class="nav-link active" href="post_create.php"><i class="ti ti-plus"></i><span class="nav-text">Create Post</span></a></li>
    ...
    <div class="row mb-4">
      <div class="col-12 d-flex justify-content-between align-items-center">
        <div>
          ...
          <p class="text-muted mb-0">Publier un nouvel article dans la communauté</p>
        </div>
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <select name="user_id" class="form-select">
                <?php foreach ($users as $u): ?>
                  <option value="<?= $u['id'] ?>" <?= ($values['user_id'] == $u['id'] || (!$values['user_id'] && $u['id'] == $_SESSION['user_id'])) ? 'selected' : '' ?>>
            ...
            <div class="col-12">
              ...
              <input type="text" name="titre"
                     ...
                     placeholder="Titre du post (3 à 200 caractères)"
            ...
            <div class="col-12">
              ...
              <textarea name="contenu" rows="10"
                        ...
                        placeholder="Rédigez l'article... (10 à 5000 caractères)"
            ...
            <div class="col-12 d-flex gap-2 pt-2">
              <button type="submit" class="btn btn-primary">
                <i class="ti ti-device-floppy me-1"></i> Créer le Post
              </button>
...
function setupCounter(fId,cId){
  const f=document.querySelector(`[name="${fId}"]`),c=document.getElementById(cId);
  if(!f||!c)return;
...
document.getElementById('adminPostForm').addEventListener('submit',function(e){
  ...
  const cat=this.querySelector('[name="categorie"]');
