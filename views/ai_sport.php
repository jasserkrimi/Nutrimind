  ...
  <div class="container">
    ...
    <div class="row mb-5">
      <div class="col-12 text-center d-flex flex-wrap justify-content-center gap-2">
        <a href="ai_sport.php"     class="ai-tab active" style="--c:#f59e0b;--cs:#d97706;">
    ...
    <div class="row">
      <div class="col-lg-10 offset-lg-1">
        <div class="ai-card" style="--accent:#f59e0b;--accent-light:#fef3c7;">
          <div class="ai-card-header" style="background:linear-gradient(135deg,#f59e0b,#fbbf24);">
            <span class="ai-card-icon">🏋️</span>
            <div>
              <h4 class="ai-card-title">Plan Sportif</h4>
              <p class="ai-card-sub">Exercices, fréquence, intensité &amp; récupération</p>
            </div>
          </div>
          <div class="ai-card-body">
            <?php echo renderAIPlan($plans['sport']); ?>
          </div>
        </div>
      </div>
    </div>
